...
// Maps our internal categories to display categories with icons

export interface BiomarkerCategory {
  id: string;
  label: string;
  icon: string; // Lucide icon name
  markerCategories: string[]; // which FUNCTIONAL_RANGES categories belong here
}

export const BIOMARKER_CATEGORIES: BiomarkerCategory[] = [
  { id: "thyroid", label: "Thyroid", icon: "Shield", markerCategories: ["Thyroid"] },
  { id: "metabolic", label: "Metabolic", icon: "Gauge", markerCategories: ["Metabolic"] },
  { id: "heart", label: "Heart", icon: "Heart", markerCategories: ["Lipids"] },
  { id: "liver", label: "Liver", icon: "Beaker", markerCategories: ["Liver"] },
  { id: "kidney", label: "Kidney", icon: "Droplets", markerCategories: ["Kidney"] },
  { id: "blood", label: "Blood", icon: "Droplet", markerCategories: ["CBC"] },
  { id: "nutrients", label: "Nutrients", icon: "Leaf", markerCategories: ["Vitamins", "Minerals"] },
  { id: "immune", label: "Immune Regulation", icon: "ShieldCheck", markerCategories: ["Inflammation", "Iron/Inflammation"] },
  { id: "hormones", label: "Hormones", icon: "Zap", markerCategories: ["Hormones"] },
  { id: "gut", label: "Gut Health", icon: "Apple", markerCategories: ["Gut Health"] },
];

export function getMarkersForBiomarkerCategory(categoryId: string): MarkerReference[] {
  const cat = BIOMARKER_CATEGORIES.find((c) => c.id === categoryId);
  if (!cat) return [];
  return Object.values(FUNCTIONAL_RANGES).filter((m) => cat.markerCategories.includes(m.category));
}
